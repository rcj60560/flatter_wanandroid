class HomeDataModel1 {
    ...
    HomeDataModel1({this.bannerList, this.config, this.gridNav, this.localNavList, this.salesBox, this.subNavList});

    factory HomeDataModel1.fromJson(Map<String, dynamic> json) {
        return HomeDataModel1(
            bannerList: json['bannerList'] != null ? (json['bannerList'] as List).map((i) => BannerHome.fromJson(i)).toList() : null,
            config: json['config'] != null ? Config.fromJson(json['config']) : null,
            gridNav: json['gridNav'] != null ? GridNav.fromJson(json['gridNav']) : null,
            localNavList: json['localNavList'] != null ? (json['localNavList'] as List).map((i) => LocalNav.fromJson(i)).toList() : null,
            salesBox: json['salesBox'] != null ? SalesBox.fromJson(json['salesBox']) : null,
            subNavList: json['subNavList'] != null ? (json['subNavList'] as List).map((i) => SubNav.fromJson(i)).toList() : null,
        );
    }
...
class Config {
    final String searchUrl; // https://m.ctrip.com/restapi/h5api/searchapp/search?source=mobileweb&action=autocomplete&contentType=json&keyword=1
...
class LocalNav {
    ...
    LocalNav({this.hideAppBar, this.icon, this.statusBarColor, this.title, this.url});
...
class Hotel {
    ...
    factory Hotel.fromJson(Map<String, dynamic> json) {
        return Hotel(
            ...
            mainItem: json['mainItem'] != null ? MainItem.fromJson(json['mainItem']) : null,
...
class MainItem {
    final String icon; // https://pic.c-ctrip.com/platform/h5/home/grid-nav-items-hotel.png
...
class Item3 {
    ...
    final String url; // https://m.ctrip.com/webapp/tuan/?secondwakeup=true&dpclickjump=true
...
class Flight {
    ...
    factory Flight.fromJson(Map<String, dynamic> json) {
        return Flight(
            ...
            mainItem: json['mainItem'] != null ? MainItemX.fromJson(json['mainItem']) : null,
            startColor: json['startColor'],
        );
    }
...
class MainItemX {
    final String icon; // https://pic.c-ctrip.com/platform/h5/home/grid-nav-items-flight.png
...
class Item1X {
    ...
    final String url; // https://m.ctrip.com/webapp/train/?secondwakeup=true&dpclickjump=true&from=https%3A%2F%2Fm.ctrip.com%2Fhtml5%2F#/index?VNK=4e431539
...
class Item4X {
    ...
    final String url; // https://m.ctrip.com/webapp/car/index?s=ctrip&from=https%3A%2F%2Fm.ctrip.com%2Fhtml5%2F
...
class Travel {
    ...
    factory Travel.fromJson(Map<String, dynamic> json) {
        return Travel(
            ...
            mainItem: json['mainItem'] != null ? MainItemXX.fromJson(json['mainItem']) : null,
            startColor: json['startColor'],
        );
    }
...
class MainItemXX {
    final bool hideAppBar; // true
    final String icon; // https://pic.c-ctrip.com/platform/h5/home/grid-nav-items-travel.png
    final String statusBarColor; // 19A0F0
    final String title; // 旅游
    final String url; // https://m.ctrip.com/webapp/vacations/tour/vacations

    MainItemXX({this.hideAppBar, this.icon, this.statusBarColor, this.title, this.url});
...
class SalesBox {
    ...
    final String icon; // https://www.devio.org/io/flutter_app/img/sales_box_huodong.png
    final String moreUrl; // https://contents.ctrip.com/activitysetupapp/mkt/index/moreact
    ...
    factory SalesBox.fromJson(Map<String, dynamic> json) {
        return SalesBox(
            bigCard1: json['bigCard1'] != null ? BigCard1.fromJson(json['bigCard1']) : null,
            bigCard2: json['bigCard2'] != null ? BigCard2.fromJson(json['bigCard2']) : null,
            icon: json['icon'],
            moreUrl: json['moreUrl'],
            smallCard1: json['smallCard1'] != null ? SmallCard1.fromJson(json['smallCard1']) : null,
            smallCard2: json['smallCard2'] != null ? SmallCard2.fromJson(json['smallCard2']) : null,
            smallCard3: json['smallCard3'] != null ? SmallCard3.fromJson(json['smallCard3']) : null,
            smallCard4: json['smallCard4'] != null ? SmallCard4.fromJson(json['smallCard4']) : null,
        );
    }
...
class SmallCard1 {
    final String icon; // https://dimg04.c-ctrip.com/images/700b0z000000neoth8688_375_160_345.jpg
    final String title; // 活动
    final String url; // https://contents.ctrip.com/activitysetupapp/mkt/index/nbaafs?pushcode=IP_nbaafs004
...
class SmallCard4 {
    final String icon; // https://dimg04.c-ctrip.com/images/700d0s000000htvwo16C4_375_160_345.jpg
    final String title; // 活动
...
class BigCard2 {
    final String icon; // https://dimg04.c-ctrip.com/images/700a10000000portu2BAD_375_260_342.jpg
    final String title; // 活动
    final String url; // https://m.ctrip.com/webapp/you/livestream/plan/crhHotelList.html?liveAwaken=true&isHideHeader=true&isHideNavBar=YES&mktcrhcode=hotevent
...
class SmallCard3 {
    final String icon; // https://dimg04.c-ctrip.com/images/700a0t000000im512AB2C_375_160_345.jpg
    final String title; // 活动
    final String url; // https://smarket.ctrip.com/webapp/promocode/add?source=5
...
class BigCard1 {
    final String icon; // https://dimg04.c-ctrip.com/images/700t0y000000m71h523FE_375_260_342.png
    final String title; // 活动
    final String url; // https://contents.ctrip.com/buildingblocksweb/special/membershipcard/index.html?sceneid=1&productid=14912&ishidenavbar=yes&pushcode=act_svip_hm31
...
class SmallCard2 {
    final String icon; // https://dimg04.c-ctrip.com/images/700w0z000000mogkyEF78_375_160_345.jpg
    final String title; // 活动
    final String url; // https://smarket.ctrip.com/webapp/promocode/add?source=5
...
class SubNav {
    final bool hideAppBar; // true
    final String icon; // https://www.devio.org/io/flutter_app/img/sub_nav_more.png
...
class BannerHome {
    final String icon; // https://dimg03.c-ctrip.com/images/fd/tg/g1/M03/7E/19/CghzfVWw6OaACaJXABqNWv6ecpw824_C_500_280_Q90.jpg
    final String url; // https://m.ctrip.com/webapp/vacations/tour/detail?productid=53720&departcityid=2&salecityid=2&from=https%3A%2F%2Fm.ctrip.com%2Fhtml5%2F
